  ...
  return (
    <section className="bg-background py-24">
      ...
      <div className="flex gap-5 items-center justify-center p-5 py-14">
        <h1 className="font-semibold">Sign Up Page</h1>
      ...
      <div className="flex flex-col gap-5 items-center justify-center p-5">
        <h1 className="font-semibold">
          Sign Up <span className="px-2 font-normal">with</span> Credentials
        </h1>
        <form className="flex gap-10 py-5" onSubmit={handleSignUp}>
          <span>
